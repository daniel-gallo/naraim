...
class TrainerClassifier:
    ...
    def train_step(self, state, rng, batch):
      loss_fn = lambda params: self.get_loss(params, rng, batch, train=True)
...
if __name__ == "__main__":
  train_dataloader = get_fashion_mnist_dataloader(pretraining=False, train=True, batch_size=1024)
  val_dataloader = get_fashion_mnist_dataloader(pretraining=False, train=False, batch_size=1024)
